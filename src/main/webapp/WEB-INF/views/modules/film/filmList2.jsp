...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/film/film/list2">电影列表</a></li>
		<shiro:hasPermission name="film:film:edit"><li><a href="${ctx}/film/film/form">电影添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="film" action="${ctx}/film/film/list2" method="post" class="breadcrumb form-search">
